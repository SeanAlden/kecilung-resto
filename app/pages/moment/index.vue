    ...
    <div class="container mx-auto px-6 max-w-6xl">
      ...
      <div class="text-center mb-16">
        ...
        <p class="text-lg text-gray-700 max-w-4xl mx-auto leading-relaxed">
          Ciptakan kenangan tak terlupakan bersama orang-orang terkasih. Kami menyediakan ruang, suasana, dan pelayanan eksklusif untuk merayakan setiap momen berharga Anda.
        </p>
      </div>
      ...
      <div v-else-if="moments.length === 0" class="text-center py-20 text-gray-500">
